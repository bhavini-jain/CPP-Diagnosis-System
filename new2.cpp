   	...
   	while(ch != 13)
		{
      		...
      		cout << "*";														//TO PRINT "*" IN PASSWORD 
      		ch = getch();
      			
   		}
   		
	while(in>>u>>p)																//READ USERNAME AND PASSWORD FROM FILE TO CHECK USER EXISTS OR NOT
	{
...
void quick_test :: analyse_symptoms()
{
	...
	{ 
	    ...
	    obj<<reguser<<" "<<"Your_risk_factor_is_low!";
	}
	...
	if((s3 =='Y'||s3=='y')||(s4 =='1'))
	{
		if(s4 =='2')
		{
			...
			obj<<reguser<<" "<<"You_should_quarantine_yourself_for_14_days_and_should_follow_all_the_precautions!!";
		}
		else
		{
			cout<<"You have high risk factor....should go for covid test as soon as possible..\n";
			obj<<reguser<<" "<<"You_have_high_risk_factor....should_go_for_covid_test_as_soon_as_possible..";
		}
	}
	else
	{
		cout<<"You are safe..but still you should follow covid precautions...Be safe!\n"; 
		obj<<reguser<<" "<<"You_are_safe..but_still_you_should_follow_covid_precautions...Be_safe!";
	}
	...
	if((s5=='A'||s5=='a')||(s5=='D'||s5=='d')||(s5=='H'||s5=='h')||(s5=='S'||s5=='s'))
	{
		if(s5=='A'||s5=='a')
		{
			...
			obj<<reguser<<" "<<"You_have_normal_symptom_of_aches_and_pains.\n";
		}
		else if(s5=='D'||s5=='d')
		{
			cout<<"You have normal symptom of diarrhoea.\n";
			obj<<reguser<<" "<<"You_have_normal_symptom_of_diarrhoea.\n";
		}
		else if(s5=='H'||s5=='h')
		{
			cout<<"You have normal symptom of Headache.\n";
			obj<<reguser<<" "<<"You_have_normal_symptom_of_Headache.\n";
		}
		else if(s5=='S'||s5=='s')
		{
			cout<<"You have normal symptom of loss of taste and smell.\n";
			obj<<reguser<<" "<<"You_have_normal_symptom_of_loss_of_taste_and_smell.\n";
		}
	}
	else
	{
		cout<<"No other disorders...You are healthy!!";
		obj<<reguser<<" "<<"No_other_disorders...You_are_healthy!!\n";
	}
